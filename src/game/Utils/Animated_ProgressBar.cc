				...
				UINT16 usLeft, UINT16 usTop, UINT16 usRight, UINT16 usBottom )
{
	...
	pCurr->usLtColor = RGB( (UINT8)MIN( 255, (UINT16)(r*1.33)),
...
void SetProgressBarTitle(UINT32 ubID, const wchar_t* pString, SGPFont const font, UINT32 ubForeColor, UINT32 ubShadowColor)
{
	PROGRESSBAR *pCurr;
	Assert( ubID < MAX_PROGRESSBARS );
	pCurr = pBar[ ubID ];
